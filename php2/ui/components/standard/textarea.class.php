...
/**
 * File contains text area component
 *
 * PHP version 5
 ...
 *
 * @author   Eugene A. Kalosha <ekalosha@gmail.com>
 * @version  $Id: textarea.class.php 98 2009-08-19 17:15:05Z eugene $
 * @access   public
 * @package  PHP2\UI\Components\Standard
 */
class PHP2_UI_Components_Standard_TextArea extends PHP2_UI_Control
{
    /**
     * Edit text
     *
    ...
    {
        return '<textarea name="'.$this->getName().'" name="'.$this->getName().'"'.$this->_getAttributesString().'>'.PHP2_Utils_String::validateXMLText($this->text).'</textarea>';
    }
